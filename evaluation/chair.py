...
zebra
giraffe
backpack, knapsack, bag
umbrella
handbag, wallet, purse, briefcase, bag
tie, bow, bow tie
...
cake,  cheesecake, cupcake, shortcake, coffeecake, pancake, birthday cake, dessert
chair, seat, stool
couch, sofa, recliner, futon, loveseat, settee, chesterfield 
potted plant, houseplant, potted flowers
bed
dining table, table, desk
toilet, urinal, commode, toilet, lavatory, potty, flush toilet
tv, monitor, televison, television
laptop, computer, notebook, netbook, lenovo, macbook, laptop computer, mac
mouse
remote, controller, console
keyboard
...
class CHAIR(object):
    ...
    def compute_chair(self, cap_file, image_id_key, caption_key):
        ...
        for i in tqdm.trange(len(caps)):
            ...
            # match = re.search(r'_(\d+)\.jpg$', imid)
            # if match:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--coco_path", type=str, default='/root/jzq/Benchmarks/COCO/annotations', # /path/to/coco/annotations
